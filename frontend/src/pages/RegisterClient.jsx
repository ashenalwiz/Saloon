...
const s = {
  ...
  leftMark: { fontSize: 32, fontWeight: 900, color: '#EC4899', marginBottom: 12, filter: 'drop-shadow(0 0 12px rgba(236,72,153,.5))' },
  ...
  leftDivider: { width: 48, height: 2, marginTop: 32, marginBottom: 28, background: 'linear-gradient(90deg, #EC4899, transparent)', borderRadius: 2 },
  ...
  leftBlob1: { position: 'absolute', width: 300, height: 300, background: 'radial-gradient(circle, rgba(236,72,153,.2) 0%, transparent 70%)', top: -80, right: -60, pointerEvents: 'none', filter: 'blur(40px)' },
  ...
  btn: { marginTop: 4, padding: '14px', background: 'linear-gradient(135deg, #7C3AED 0%, #9B59E8 50%, #EC4899 100%)', color: '#fff', border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 600, cursor: 'pointer', width: '100%', boxShadow: '0 6px 20px rgba(124,58,237,.35), inset 0 1px 0 rgba(255,255,255,.15)' },
