...
const s = {
  ...
  addBtn: {
    padding: '10px 22px', background: 'linear-gradient(135deg, #7C3AED 0%, #EC4899 100%)',
  ...
  dayChipOn: { background: 'linear-gradient(135deg, #7C3AED, #EC4899)', color: '#fff', borderColor: 'transparent', boxShadow: '0 3px 10px rgba(124,58,237,.3)' },
  ...
  saveBtn: {
    padding: '10px 26px', background: 'linear-gradient(135deg, #7C3AED 0%, #EC4899 100%)',
  ...
  emptyIcon: { fontSize: 40, marginBottom: 16, display: 'inline-flex', width: 72, height: 72, borderRadius: 20, alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #7C3AED 0%, #EC4899 100%)', color: '#fff' },
  emptyTitle: { fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: 'var(--text)', margin: '0 0 8px' },
  emptyBtn: { marginTop: 20, padding: '11px 26px', background: 'linear-gradient(135deg, #7C3AED 0%, #EC4899 100%)', color: '#fff', border: 'none', borderRadius: 12, cursor: 'pointer', fontWeight: 700, fontSize: 14 },
};
